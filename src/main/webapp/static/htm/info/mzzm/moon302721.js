...
if(t++,t==e.length){
var n=+new Date-o;
seajs.combo_status=seajs.COMBO_LOADED,seajs.run(),console.debug&&console.debug("[moon] load js complete, url num : "+e.length+", total mod count : "+u.mod_num+", hit num: "+u.hit_num+", use time : "+n+"ms");
}
});
});
},

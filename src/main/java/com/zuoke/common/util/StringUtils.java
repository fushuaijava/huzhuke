...
public class StringUtils {
	 ...
	 * 
	 * @param formatString
	 *            （例：yyyyMMddhhmmss,yyyy-MM-dd 等等）
	 * @return
	 */
	 ...
	 * @return
	 */
	public static String setScale(String string, int icount) {
		try {
			BigDecimal b = new BigDecimal(string);
			String str = b.setScale(icount, BigDecimal.ROUND_HALF_UP)
					.toString();
			return str;
		} catch (Exception e) {
			e.printStackTrace();
	 ...
	 * @return
	 */
	public static boolean isEqualsOne(String r) {
		return "1".equals(r);
	}
	 ...
	 * @return
	 */
	public static boolean isEqualsZero(String r) {
		return "0".equals(r);
	}
	 ...
	 * <li>目的：字符串是否为null或者长度为0</li>
	 * <li>适用的前提条件:</li>
	 * <li>后置条件：</li>
	 * <li>例外处理：无</li>
	 * <li>已知问题：</li>
	 * <li>调用的例子：boolean isEmpty = StringUtil.isEmpty(str);</li>
	 * </ul>
	 * </p>
	 * 
	 * @param str
	 ...
	 * <ul>
	 * <li>可见性原因：需要被其他应用调用</li>
	 * <li>目的：字符串不为null且长度不为0时返回true,否则返回false</li>
	 * <li>调用的例子：boolean isNotEmpty = StringUtil.isNotEmpty(str);</li>
	 * </ul>
	 * </p>
	 * 
	 * @param str
	 ...
	 * <ul>
	 * <li>可见性原因：需要被其他应用调用</li>
	 * <li>目的：字符串为null或者长度为0，或者全部是空白字符时返回为真</li>
	 * <li>调用的例子：</li>
	 * </ul>
	 * </p>
	 * 
	 ...
	 * <ul>
	 * <li>可见性原因：需要被其他应用调用</li>
	 * <li>目的：字符串不为空、长度不为0，且非空白字符串时返回为真</li>
	 * <li>适用的前提条件:</li>
	 * <li>后置条件：</li>
	 * <li>例外处理：无</li>
	 * <li>已知问题：</li>
	 ...
	 * @return
	 */
	public static int paseInt(Object obj, int defaultInt) {
		try {
			if (null == obj) {
				return defaultInt;
			} else {
	 ...
	 * @return
	 */
	public static long paseLong(Object obj, long defaultLong) {
		try {
			if (null == obj) {
				return defaultLong;
			} else {
	 ...
	 * @return
	 */
	public static float paseFloat(Object obj, float defaultFloat) {
		try {
			if (null == obj) {
				return defaultFloat;
			} else {
	 ...
	 * <ul>
	 * <li>可见性原因：需要被其他应用调用</li>
	 * <li>目的：去掉空白后，如长度为0，返回null，否则返回字符串</li>
	 * <li>调用的例子：
	 * 
	 * <pre>
	 ...
	 * <ul>
	 * <li>可见性原因：需要被其他应用调用</li>
	 * <li>目的：字符串为null返回""，否则返回去掉空白字符的字符串</li>
	 * <li>调用的例子： StringUtils.trimToEmpty(null) = &quot;&quot;
	 * StringUtils.trimToEmpty(&quot;&quot;) = &quot;&quot;
	 * StringUtils.trimToEmpty(&quot; &quot;) = &quot;&quot;
	 * StringUtils.trimToEmpty(&quot;abc&quot;) = &quot;abc&quot;
	 * StringUtils.trimToEmpty(&quot; abc &quot;) = &quot;abc&quot;</li>
	 * </ul>
	 * </p>
	 * 
	 * @param str
	 ...
	 * <ul>
	 * <li>可见性原因：需要被其他应用调用</li>
	 * <li>目的：不区分大小写的匹配模式,已进行null判断</li>
	 * <li>调用的例子：
	 * 
	 * <pre>
	 ...
	 * <ul>
	 * <li>可见性原因：需要被其他应用调用</li>
	 * <li>目的：查找字符串中特定字符的位置，已进行null值判断</li>
	 * <li>调用的例子：
	 * 
	 * <pre>
	 ...
	 * <ul>
	 * <li>可见性原因：需要被其他应用调用</li>
	 * <li>目的：从指定位置开始查找指定字符，已进行null值判断</li>
	 * <li>调用的例子：
	 * 
	 * <pre>
	 * StringUtils.indexOf(null, *, *)          = -1
	 ...
	 * <ul>
	 * <li>可见性原因：需要被其他应用调用</li>
	 * <li>目的：在字符串中查找指定字符串，已进行null值判断</li>
	 * <li>调用的例子：
	 * 
	 * <pre>
	 * StringUtils.indexOf(null, *)          = -1
	 ...
	 * <ul>
	 * <li>可见性原因：需要被其他应用调用</li>
	 * <li>目的：在字符串中查找指定出现的顺序次数的字符串的位置</li>
	 * <li>调用的例子：
	 * 
	 * <pre>
	 ...
	 * <ul>
	 * <li>可见性原因：需要被其他应用调用</li>
	 * <li>目的：从指定位置开始查找字符串出现的位置,已进行null处理</li>
	 * <li>适用的前提条件:</li>
	 * <li>后置条件：</li>
	 * <li>例外处理：无</li>
	 * <li>已知问题：</li>
	 ...
	 * <ul>
	 * <li>可见性原因：需要被其他应用调用</li>
	 * <li>目的：从后向前查找字符串的出现位置，已进行null值处理</li>
	 * <li>调用的例子：</li>
	 * </ul>
	 * </p>
	 * 
